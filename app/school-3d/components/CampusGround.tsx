...
export default function CampusGround() {
  ...
  const roads = useMemo(() => {
    // Roads and white-line markings removed per Tyler's request — the campus
    // is now fully pedestrian (green quads between buildings with cobblestone
    // avenues + branches connecting everything).
    return [] as RoadSeg[];
  }, []);
