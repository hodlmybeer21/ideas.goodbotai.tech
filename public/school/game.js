...
(() => {
  ...
  var BUILDINGS = [
    { key:'artroom',    label:'Art Studio',        sublabel:'🎨 Creative Corner',  x:80,   y:60,  w:340, h:280, roofOffY:32, trimColor:C.artroom,    doorSide:'front', stations:[{id:'colorlab',sx:220,sy:200},{id:'pixelcanvas_b',sx:300,sy:200},{id:'drawingcanvas',sx:150,sy:290}] },
    ...
    { key:'gym',       label:'Gymnasium',           sublabel:'🏃 Fitness',         x:80,   y:400, w:350, h:300, roofOffY:36, trimColor:C.gym,        doorSide:'right',  stations:[{id:'bossyr',sx:200,sy:530},{id:'mathrace',sx:310,sy:530}] },
    ...
    { key:'mathroom',  label:'Math Den',            sublabel:'🧮 Numbers',         x:790,  y:1100,w:300, h:240, roofOffY:28, trimColor:C.mathroom,   doorSide:'front',  stations:[{id:'mathlab',sx:860,sy:1220},{id:'tensonesexplorer',sx:960,sy:1220}] },
    ...
    { key:'playground',label:'Playground',          sublabel:'🌤️ Outdoor Fun',    x:1520, y:1050,w:380, h:200, roofOffY:0,  trimColor:C.playground,doorSide:'none',   stations:[{id:'statefinder',sx:1580,sy:1130},{id:'truefalse',sx:1710,sy:1130},{id:'vocabventure',sx:1840,sy:1130}] },
