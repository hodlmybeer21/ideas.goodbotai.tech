...
(() => {
  ...
  var BUILDINGS = [
    ...
    { key:'library',    label:'Library',            sublabel:'📚 Story Hall',      x:470,  y:60,  w:360, h:280, roofOffY:32, trimColor:C.library,    doorSide:'front', stations:[{id:'storymachine',sx:530,sy:200},{id:'readalong',sx:630,sy:200},{id:'storyqa',sx:720,sy:290},{id:'prefixpals',sx:500,sy:250},{id:'pluralpuzzlers',sx:560,sy:250},{id:'contextcluecove',sx:620,sy:250},{id:'commacrew',sx:680,sy:250},{id:'conjunctionjunction',sx:740,sy:250},{id:'poetrypark',sx:800,sy:250},{id:'adjectiveadventure',sx:500,sy:330},{id:'verbvault',sx:580,sy:330}] },
    { key:'sciceng',   label:'Science Lab',         sublabel:'🔬 Experiments',     x:1480, y:60,  w:340, h:260, roofOffY:32, trimColor:C.sciceng,    doorSide:'left',   stations:[{id:'plantcycle',sx:1580,sy:200},{id:'soundlab',sx:1680,sy:200},{id:'earthexplorer',sx:1500,sy:290},{id:'mattermixer',sx:1620,sy:290},{id:'mapskills',sx:1740,sy:290},{id:'fivesenseslab',sx:1500,sy:230},{id:'communityhelpers',sx:1620,sy:230}] },
    ...
    { key:'mathroom',  label:'Math Den',            sublabel:'🧮 Numbers',         x:790,  y:1100,w:300, h:240, roofOffY:28, trimColor:C.mathroom,   doorSide:'front', stations:[{id:'mathlab',sx:860,sy:1220},{id:'tensonesexplorer',sx:960,sy:1220},{id:'numberbingo',sx:1030,sy:1220},{id:'shapesafari',sx:820,sy:1280},{id:'oddeven',sx:860,sy:1280},{id:'comparecastles',sx:900,sy:1280},{id:'timetravel',sx:940,sy:1280},{id:'tripledigit',sx:980,sy:1280},{id:'arrayarchitect',sx:1020,sy:1280},{id:'hundreds',sx:1060,sy:1280},{id:'wordproblemwoods',sx:820,sy:1340},{id:'measureme',sx:860,sy:1340},{id:'placevaluepirates',sx:900,sy:1340},{id:'graphgarden',sx:940,sy:1340},{id:'plusminus10and100',sx:980,sy:1340},{id:'symmetrysafari',sx:1020,sy:1340}] },
    { key:'musicrm',   label:'Music Room',          sublabel:'🎵 Sounds',         x:1160, y:1100,w:290, h:240, roofOffY:28, trimColor:C.musicrm,    doorSide:'front', stations:[{id:'syllable_b',sx:1180,sy:1220},{id:'madlibs',sx:1290,sy:1220},{id:'beatcomposer',sx:1400,sy:1220}] },
    { key:'playground',label:'Playground',          sublabel:'🌤️ Outdoor Fun',    x:1520, y:1050,w:510, h:200, roofOffY:0,  trimColor:C.playground,doorSide:'none',   stations:[{id:'statefinder',sx:1580,sy:1130},{id:'truefalse',sx:1710,sy:1130},{id:'bugcatcher',sx:1840,sy:1130},{id:'dotsandboxes',sx:1970,sy:1130},{id:'tictactoe',sx:1580,sy:1180},{id:'game2048',sx:1710,sy:1180},{id:'threes',sx:1840,sy:1180},{id:'match3',sx:1970,sy:1180},{id:'stacktower',sx:1500,sy:1130},{id:'flappybird',sx:1620,sy:1130},{id:'tetris',sx:1500,sy:1180},{id:'wordle',sx:1840,sy:1130},{id:'penguins',sx:1500,sy:1130},{id:'lunarlander',sx:1620,sy:1130},{id:'avalanche',sx:1500,sy:1180},{id:'galaxy',sx:1620,sy:1180},{id:'tank',sx:1840,sy:1180}] },
  ...
  var ACTIVITIES = {
    colorlab:{name:'Color Lab',icon:'🎨',component:'colorlab'},pixelcanvas_b:{name:'Pixel Canvas',icon:'🎮',component:'pixelcanvas_b'},mathlab:{name:'Math Lab',icon:'🔢',component:'mathlab'},syllable_b:{name:'Syllable Scooper',icon:'🔤',component:'syllable_b'},madlibs:{name:'Mad Libs',icon:'📝',component:'madlibs'},readalong:{name:'Read Along',icon:'🎵',component:'readalong'},animatch:{name:'Animal Match',icon:'🧩',component:'animatch'},storymachine:{name:'Story Machine',icon:'📖',component:'storymachine'},sentencefixer:{name:'Sentence Fixer',icon:'✏️',component:'sentencefixer'},basewordsorter:{name:'Baseword Sorter',icon:'🔗',component:'basewordsorter'},pluralbuilder:{name:'Plural Builder',icon:'🔠',component:'pluralbuilder'},characterraits:{name:'Character Traits',icon:'🎭',component:'characterraits'},storyqa:{name:'Story Q&A',icon:'❓',component:'storyqa'},equalparts:{name:'Equal Parts',icon:'🔴',component:'equalparts'},tensonesexplorer:{name:'Tens & Ones',icon:'🔢',component:'tensonesexplorer'},coinchallenge:{name:'Coin Challenge',icon:'🪙',component:'coinchallenge'},telltime:{name:'Tell Time',icon:'🕐',component:'telltime'},codebots:{name:'CodeBots',icon:'🤖',component:'codebots'},bossyr:{name:'Bossy R Racer',icon:'🏎️',component:'bossyr'},soundlab:{name:'Sound Lab',icon:'🎵',component:'soundlab'},plantcycle:{name:'Plant Life Cycle',icon:'🌱',component:'plantcycle'},statefinder:{name:'State Finder',icon:'🗺️',component:'statefinder'},truefalse:{name:'True or False',icon:'✅',component:'truefalse'},istherobotright:{name:'Robot Checker',icon:'🤖',component:'istherobotright'},drawingcanvas:{name:'Magic Canvas',icon:'🖌️',component:'drawingcanvas'},wordsearch:{name:'Word Search',icon:'🔍',component:'wordsearch'},vocabventure:{name:'Vocab Venture',icon:'🎯',component:'vocabventure'},bugcatcher:{name:'Bug Catcher',icon:'🐛',component:'bugcatcher'},bunnyhop:{name:'Bunny Hop Counting',icon:'🐰',component:'bunnyhop'},photoframe:{name:'Photo Frame Maker',icon:'🖼️',component:'photoframe'},mirrordraw:{name:'Mirror Draw',icon:'🪞',component:'mirrordraw'},numberbingo:{name:'Number Bingo',icon:'🎯',component:'numberbingo'},beatcomposer:{name:'Beat Composer',icon:'🎵',component:'beatcomposer'},dotsandboxes:{name:'Dots & Boxes',icon:'📦',component:'dotsandboxes'},mathrace:{name:'Math Race',icon:'🏃',component:'mathrace'},readingrace:{name:'Reading Race',icon:'📚',component:'readingrace'},shapesafari:{name:'Shape Safari',icon:'🦒',component:'shapesafari'},oddeven:{name:'Odd-Even Oasis',icon:'🐫',component:'oddeven'},comparecastles:{name:'Compare Castles',icon:'🏰',component:'comparecastles'},timetravel:{name:'Time Travel',icon:'⏳',component:'timetravel'},tripledigit:{name:'Triple-Digit Treasure',icon:'💎',component:'tripledigit'},arrayarchitect:{name:'Array Architect',icon:'🏗️',component:'arrayarchitect'},hundreds:{name:'Hundreds Hide & Seek',icon:'🔍',component:'hundreds'},prefixpals:{name:'Prefix Pals',icon:'🔑',component:'prefixpals'},pluralpuzzlers:{name:'Plural Puzzlers',icon:'🧩',component:'pluralpuzzlers'},contextcluecove:{name:'Context Clue Cove',icon:'🔎',component:'contextcluecove'},commacrew:{name:'Comma Crew',icon:'✉️',component:'commacrew'},conjunctionjunction:{name:'Conjunction Junction',icon:'🚂',component:'conjunctionjunction'},poetrypark:{name:'Poetry Park',icon:'🎭',component:'poetrypark'},earthexplorer:{name:'Earth Explorer',icon:'🌍',component:'earthexplorer'},mattermixer:{name:'Matter Mixer',icon:'🧪',component:'mattermixer'},wordproblemwoods:{name:'Word Problem Woods',icon:'🌲',component:'wordproblemwoods'},measureme:{name:'Measure Me',icon:'📏',component:'measureme'},placevaluepirates:{name:'Place Value Pirates',icon:'🏴‍☠️',component:'placevaluepirates'},graphgarden:{name:'Graph Garden',icon:'📊',component:'graphgarden'},plusminus10and100:{name:'Plus/Minus 10 and 100',icon:'🚀',component:'plusminus10and100'},adjectiveadventure:{name:'Adjective Adventure',icon:'✍️',component:'adjectiveadventure'},verbvault:{name:'Verb Vault',icon:'🕰️',component:'verbvault'},symmetrysafari:{name:'Symmetry Safari',icon:'🦋',component:'symmetrysafari'},mapskills:{name:'Map Skills',icon:'🗺️',component:'mapskills'},fivesenseslab:{name:'Five Senses Lab',icon:'👁️',component:'fivesenseslab'},communityhelpers:{name:'Community Helpers',icon:'👮',component:'communityhelpers'},tictactoe:{name:'Tic Tac Toe',icon:'⭕',component:'tictactoe'},game2048:{name:'2048',icon:'🔢',component:'game2048'},threes:{name:'Threes',icon:'🎲',component:'threes'},match3:{name:'Match-3',icon:'🍬',component:'match3'},stacktower:{name:'Stack Tower',icon:'🏗️',component:'stacktower'},flappybird:{name:'Flappy Bird',icon:'🐦',component:'flappybird'},tetris:{name:'Tetris',icon:'🧱',component:'tetris'},wordle:{name:'Wordle',icon:'🟩',component:'wordle'},penguins:{name:'Penguins',icon:'🐧',component:'penguins'},lunarlander:{name:'Lunar Lander',icon:'🌙',component:'lunarlander'},avalanche:{name:'Avalanche',icon:'🪨',component:'avalanche'},galaxy:{name:'Galaxy Defenders',icon:'👾',component:'galaxy'},tank:{name:'Indestructotank',icon:'🚜',component:'tank'},
  };
